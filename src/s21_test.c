...
START_TEST(sqrt_0) {
  ck_assert_ldouble_eq_tol(sqrt(0), s21_sqrt(0), S21_PRECISION);
  ck_assert_ldouble_eq_tol(sqrt(4), s21_sqrt(4), S21_PRECISION);
...
START_TEST(pow_8) {
  double base = 1.2;
  int exp = 1.1;
  ck_assert_ldouble_eq_tol(pow(base, exp), s21_pow(base, exp), S21_PRECISION);
}
END_TEST
...
START_TEST(asin_1) {
  ...
  ck_assert_ldouble_eq_tol(a, b, S21_PRECISION);
}
END_TEST
...
START_TEST(exp_1) {
  double a = 0;
  ck_assert_ldouble_eq_tol(exp(a), s21_exp(a), S21_PRECISION);
}
END_TEST
...
START_TEST(log_4) {
  double a = 131223;
  ck_assert_ldouble_eq_tol(log(a), s21_log(a), S21_PRECISION);
}
END_TEST
...
START_TEST(pow_test_3) {
  ...
  ck_assert_ldouble_eq(pow(-INFINITY, -3), s21_pow(-INFINITY, -3));
  ck_assert_ldouble_eq(pow(-INFINITY, 3), s21_pow(-INFINITY, 3));
  ck_assert_ldouble_eq(pow(-INFINITY, 10), s21_pow(-INFINITY, 10));
  ck_assert_ldouble_eq(pow(1, -INFINITY), s21_pow(1, -INFINITY));
  ck_assert_ldouble_eq(pow(1, NAN), s21_pow(1, S21_NAN));
  ck_assert_ldouble_nan(s21_pow(S21_NAN, INFINITY));
  ck_assert_ldouble_nan(s21_pow(INFINITY, S21_NAN));
  ck_assert_ldouble_nan(s21_pow(S21_NAN, -INFINITY));
  ck_assert_ldouble_nan(s21_pow(-INFINITY, S21_NAN));
...
START_TEST(log_test_5) {
  ...
  ck_assert_ldouble_eq_tol(log(1), s21_log(1), S21_PRECISION);
  ck_assert_ldouble_eq_tol(log(S21_E), s21_log(S21_E), S21_PRECISION);
  ck_assert_ldouble_eq_tol(log(2), s21_log(2), S21_PRECISION);
}
END_TEST
...
START_TEST(sin_cos_tan_test) {
  ...
  ck_assert_ldouble_nan(s21_cos(-INFINITY));
  ck_assert_ldouble_nan(s21_tan(-INFINITY));
  ck_assert_ldouble_eq_tol(tan(S21_PI_2), s21_tan(S21_PI_2), S21_PRECISION);
  ck_assert_ldouble_eq_tol(tan(-S21_PI_2), s21_tan(-S21_PI_2), S21_PRECISION);
}
END_TEST
...
START_TEST(exp_test_4) {
  ...
  ck_assert_ldouble_eq_tol(exp(1.0), s21_exp(1.0), S21_PRECISION);
}
END_TEST
...
START_TEST(asin_test_1) {
  ...
  ck_assert_ldouble_eq_tol(asin(1), s21_asin(1), S21_PRECISION);
}
END_TEST
...
START_TEST(sqrt_test_2) {
  ...
  ck_assert_ldouble_eq_tol(s21_sqrt(1000), sqrt(1000), S21_PRECISION);
...
START_TEST(atan_test_2) {
  double a = 12;
  ck_assert_ldouble_eq_tol(atan(a), s21_atan(a), S21_PRECISION);
  a = 0.4;
  ck_assert_ldouble_eq_tol(atan(a), s21_atan(a), S21_PRECISION);
  a = -0.333;
  ck_assert_ldouble_eq_tol(atan(a), s21_atan(a), S21_PRECISION);
...
START_TEST(asin_acos_atan_test) {
  ...
  ck_assert_ldouble_nan(s21_asin(-INFINITY));
  ck_assert_ldouble_nan(s21_acos(-INFINITY));
  ck_assert_ldouble_eq(atan(-INFINITY), atan(-INFINITY));
...
START_TEST(fmod_test_1) {
  ...
  ck_assert_ldouble_eq(fmod(-1, -INFINITY), s21_fmod(-1, -INFINITY));
  ck_assert_ldouble_eq(fmod(0, INFINITY), s21_fmod(0, INFINITY));
  ...
  ck_assert_ldouble_nan(s21_fmod(S21_NAN, INFINITY));
  ck_assert_ldouble_nan(s21_fmod(INFINITY, S21_NAN));
  ck_assert_ldouble_nan(s21_fmod(S21_NAN, -INFINITY));
  ck_assert_ldouble_nan(s21_fmod(-INFINITY, S21_NAN));
...
START_TEST(s21_acos_1) {
  ...
  ck_assert_ldouble_eq_tol(s21_acos(test_val), acos(test_val), S21_PRECISION);
}
END_TEST
...
START_TEST(s21_acos_21) {
  for (int i = 0; i < 5; ++i) {
    ...
    ck_assert_ldouble_eq_tol(s21_acos(test_val_m), acos(test_val_m),
                             S21_PRECISION);
  }
}
END_TEST
...
START_TEST(s21_asin_1) {
  long double test_val = 1;
  ck_assert_ldouble_eq_tol(s21_asin(test_val), asin(test_val), S21_PRECISION);
}
END_TEST
...
START_TEST(s21_asin_21) {
  for (int i = 0; i < 5; ++i) {
    ...
    ck_assert_ldouble_eq_tol(s21_asin(test_val), asin(test_val), S21_PRECISION);
    long double test_val_m = -i * 0.01 * S21_PI;
    ck_assert_ldouble_eq_tol(s21_asin(test_val_m), asin(test_val_m),
                             S21_PRECISION);
  }
}
END_TEST
...
START_TEST(s21_atan_1) {
  long double test_val = 1;
  ck_assert_ldouble_eq_tol(s21_atan(test_val), atan(test_val), S21_PRECISION);
}
END_TEST
...
START_TEST(s21_atan_21) {
  for (int i = 0; i < 5; ++i) {
    ...
    ck_assert_ldouble_eq_tol(s21_atan(test_val_m), atan(test_val_m),
                             S21_PRECISION);
  }
}
END_TEST
...
START_TEST(s21_ceil_16) { ck_assert_ldouble_eq(s21_ceil(9.0), ceil(9.0)); }
END_TEST

START_TEST(s21_ceil_17) { ck_assert_ldouble_eq(s21_ceil(-9.0), ceil(-9.0)); }
END_TEST
...
START_TEST(s21_cos_1) {
  long double test_val = 1;
  ck_assert_ldouble_eq_tol(s21_cos(test_val), cos(test_val), S21_PRECISION);
}
END_TEST
...
START_TEST(s21_cos_21) {
  for (int i = 0; i < 5; ++i) {
    ...
    ck_assert_ldouble_eq_tol(s21_cos(test_val), cos(test_val), S21_PRECISION);
    long double test_val_m = -i * S21_PI;
    ck_assert_ldouble_eq_tol(s21_cos(test_val_m), cos(test_val_m),
                             S21_PRECISION);
  }
}
END_TEST
...
START_TEST(s21_cos_22) {
  for (double i = -S21_PI; i <= S21_PI; i += 1.234567) {
    ck_assert_ldouble_eq_tol(cos(1234567890.123456 + i),
                             s21_cos(1234567890.123456 + i), S21_PRECISION);
  }
}
END_TEST
...
START_TEST(s21_exp_1) {
  ck_assert_ldouble_eq_tol(s21_exp(1), exp(1), S21_PRECISION);
}
END_TEST

START_TEST(s21_exp_2) {
  ck_assert_ldouble_eq_tol(s21_exp(15), exp(15), S21_PRECISION);
}
END_TEST

START_TEST(s21_exp_3) {
  ck_assert_ldouble_eq_tol(s21_exp(0.2544576373), exp(0.2544576373),
                           S21_PRECISION);
}
END_TEST

START_TEST(s21_exp_4) {
  ck_assert_ldouble_eq_tol(s21_exp(-6), exp(-6), S21_PRECISION);
}
END_TEST
...
START_TEST(s21_exp_6) {
  ck_assert_ldouble_eq_tol(s21_exp(0), exp(0), S21_PRECISION);
}
END_TEST
...
START_TEST(s21_exp_9) {
  long double test_val = INFINITY;
  ck_assert_ldouble_eq_tol(s21_exp(-test_val), exp(-test_val), S21_PRECISION);
}
END_TEST
...
START_TEST(s21_exp_11) {
  ck_assert_ldouble_eq_tol(s21_exp(-999999), exp(-999999), S21_PRECISION);
}
END_TEST

START_TEST(s21_exp_12) {
  ck_assert_ldouble_eq_tol(s21_exp(-1.156156), exp(-1.156156), S21_PRECISION);
}
END_TEST
...
START_TEST(s21_exp_15) {
  ck_assert_ldouble_eq_tol(s21_exp(-0.5555555555555555),
                           exp(-0.5555555555555555), S21_PRECISION);
}
END_TEST
...
START_TEST(s21_floor_9) {
  ck_assert_ldouble_eq_tol(s21_floor(0.999), floor(0.999), S21_PRECISION);
}
END_TEST

START_TEST(s21_floor_10) {
  ck_assert_ldouble_eq_tol(s21_floor(1.999), floor(1.999), S21_PRECISION);
}
END_TEST
...
START_TEST(s21_floor_18) { ck_assert_ldouble_eq(s21_floor(19.0), floor(19.0)); }
END_TEST

START_TEST(s21_floor_19) {
  ck_assert_ldouble_eq(s21_floor(-19.0), floor(-19.0));
}
END_TEST
...
START_TEST(s21_fmod_1) {
  ck_assert_ldouble_eq_tol(s21_fmod(7.3, 2.9), fmod(7.3, 2.9), S21_PRECISION);
}
END_TEST

START_TEST(s21_fmod_2) {
  ck_assert_ldouble_eq_tol(s21_fmod(15.5, 2.2), fmod(15.5, 2.2), S21_PRECISION);
}
END_TEST

START_TEST(s21_fmod_3) {
  ck_assert_ldouble_eq_tol(s21_fmod(21, 5), fmod(21, 5), S21_PRECISION);
}
END_TEST
...
START_TEST(s21_fmod_5) {
  ck_assert_ldouble_eq_tol(s21_fmod(15.5, -5), fmod(15.5, -5), S21_PRECISION);
}
END_TEST
...
START_TEST(s21_fmod_7) {
  ck_assert_ldouble_eq_tol(s21_fmod(-15.5, -2.2), fmod(-15.5, -2.2),
                           S21_PRECISION);
}
END_TEST
...
START_TEST(s21_fmod_12) {
  ck_assert_ldouble_eq_tol(s21_fmod(2.549849898494, INFINITY),
                           fmod(2.549849898494, INFINITY), S21_PRECISION);
}
END_TEST

START_TEST(s21_fmod_13) {
  ck_assert_ldouble_nan(s21_fmod(INFINITY, 2.549849898494));
  ck_assert_ldouble_nan(fmod(INFINITY, 2.549849898494));
}
END_TEST
...
START_TEST(s21_fmod_15) {
  ck_assert_ldouble_eq_tol(s21_fmod(12, 1e-8), fmod(12, 1e-8), S21_PRECISION);
}
END_TEST

START_TEST(s21_fmod_16) {
  ck_assert_ldouble_eq_tol(s21_fmod(12, 2), fmod(12, 2), S21_PRECISION);
}
END_TEST

START_TEST(s21_fmod_17) {
  ck_assert_ldouble_eq_tol(s21_fmod(0.0000000000000000009, 50),
                           fmod(0.0000000000000000009, 50), S21_PRECISION);
}
END_TEST
...
START_TEST(s21_fmod_19) {
  ck_assert_ldouble_eq_tol(s21_fmod(-9e-10, 50), fmod(-9e-10, 50),
                           S21_PRECISION);
}
END_TEST

START_TEST(s21_fmod_20) {
  ck_assert_ldouble_eq_tol(s21_fmod(50, -9e-10), fmod(50, -9e-10),
                           S21_PRECISION);
}
END_TEST
...
START_TEST(s21_fmod_22) {
  ck_assert_ldouble_eq_tol(s21_fmod(-123456789.0, -0.000001),
                           fmod(-123456789.0, -0.000001), S21_PRECISION);
}
END_TEST

START_TEST(s21_fmod_23) {
  ck_assert_ldouble_nan(s21_fmod(-INFINITY, 50));
  ck_assert_ldouble_nan(fmod(-INFINITY, 50));
}
END_TEST
...
START_TEST(s21_log_1) {
  ck_assert_ldouble_eq_tol(s21_log(1), log(1), S21_PRECISION);
}
END_TEST

START_TEST(s21_log_2) {
  ck_assert_ldouble_eq_tol(s21_log(15), log(15), S21_PRECISION);
}
END_TEST

START_TEST(s21_log_3) {
  ck_assert_ldouble_eq_tol(s21_log(0.2544576373), log(0.2544576373),
                           S21_PRECISION);
}
END_TEST
...
START_TEST(s21_log_6) {
  ck_assert_ldouble_eq_tol(s21_log(1.123123), log(1.123123), S21_PRECISION);
}
END_TEST
...
START_TEST(s21_log_9) {
  ck_assert_ldouble_eq_tol(s21_log(999), log(999), S21_PRECISION);
}
END_TEST

START_TEST(s21_log_10) {
  ck_assert_ldouble_eq_tol(s21_log(21), log(21), S21_PRECISION);
}
END_TEST

START_TEST(s21_log_11) {
  ck_assert_ldouble_eq_tol(s21_log(1.156156), log(1.156156), S21_PRECISION);
}
END_TEST
...
START_TEST(s21_log_15) {
  ck_assert_ldouble_eq_tol(s21_log(25.978987987879978778),
                           log(25.978987987879978778), S21_PRECISION);
}
END_TEST
...
START_TEST(s21_log_18) {
  ck_assert_ldouble_eq_tol(s21_log(2), log(2), S21_PRECISION);
}
END_TEST

START_TEST(s21_pow_1) {
  ck_assert_ldouble_eq_tol(s21_pow(0, 5), pow(0, 5), S21_PRECISION);
}
END_TEST
...
START_TEST(s21_pow_4) {
  ck_assert_ldouble_eq_tol(s21_pow(0, 5.5), pow(0, 5.5), S21_PRECISION);
}
END_TEST
...
START_TEST(s21_pow_7) {
  ck_assert_ldouble_eq_tol(s21_pow(0, 0), pow(0, 0), S21_PRECISION);
}
END_TEST

START_TEST(s21_pow_8) {
  ck_assert_ldouble_eq_tol(s21_pow(0.0, INFINITY), pow(0.0, INFINITY),
                           S21_PRECISION);
}
END_TEST

START_TEST(s21_pow_9) {
  ck_assert_ldouble_infinite(s21_pow(0, -INFINITY));
  ck_assert_ldouble_infinite(pow(0, -INFINITY));
}
END_TEST
...
START_TEST(s21_pow_11) {
  ck_assert_ldouble_eq_tol(s21_pow(-1, 5), pow(-1, 5), S21_PRECISION);
}
END_TEST
...
START_TEST(s21_pow_17) {
  ck_assert_ldouble_eq_tol(s21_pow(-1, 0), pow(-1, 0), S21_PRECISION);
}
END_TEST
...
START_TEST(s21_pow_22) {
  ck_assert_ldouble_eq_tol(s21_pow(1, 5.5), pow(1, 5.5), S21_PRECISION);
}
END_TEST
...
START_TEST(s21_pow_24) {
  ck_assert_ldouble_eq_tol(s21_pow(1, S21_NAN), pow(1, S21_NAN), S21_PRECISION);
}
END_TEST

START_TEST(s21_pow_25) {
  ck_assert_ldouble_eq_tol(s21_pow(1, -S21_NAN), pow(1, -S21_NAN),
                           S21_PRECISION);
}
END_TEST
...
START_TEST(s21_pow_29) {
  ck_assert_ldouble_eq_tol(s21_pow(5, 0), pow(5, 0), S21_PRECISION);
}
END_TEST
...
START_TEST(s21_pow_31) {
  ck_assert_ldouble_eq_tol(s21_pow(5.5, 0), pow(5.5, 0), S21_PRECISION);
}
END_TEST
...
START_TEST(s21_pow_33) {
  ck_assert_ldouble_eq_tol(s21_pow(S21_NAN, 0), pow(S21_NAN, 0), S21_PRECISION);
}
END_TEST

START_TEST(s21_pow_34) {
  ck_assert_ldouble_eq_tol(s21_pow(-S21_NAN, 0), pow(-S21_NAN, 0),
                           S21_PRECISION);
}
END_TEST
...
START_TEST(s21_pow_38) {
  ck_assert_ldouble_infinite(s21_pow(INFINITY, 5));
  ck_assert_ldouble_infinite(pow(INFINITY, 5));
}
END_TEST
...
START_TEST(s21_pow_40) {
  ck_assert_ldouble_infinite(s21_pow(INFINITY, 5.5));
  ck_assert_ldouble_infinite(pow(INFINITY, 5.5));
}
END_TEST

START_TEST(s21_pow_41) {
  ck_assert_ldouble_eq_tol(s21_pow(INFINITY, -5.5), pow(INFINITY, -5.5),
                           S21_PRECISION);
}
END_TEST
...
START_TEST(s21_pow_42) {
  ck_assert_ldouble_nan(s21_pow(INFINITY, S21_NAN));
  ck_assert_ldouble_nan(pow(INFINITY, S21_NAN));
}
END_TEST
...
START_TEST(s21_pow_46) {
  ck_assert_ldouble_eq_tol(s21_pow(INFINITY, -INFINITY),
                           pow(INFINITY, -INFINITY), S21_PRECISION);
}
END_TEST
...
START_TEST(s21_pow_56) {
  ck_assert_ldouble_eq_tol(s21_pow(0.5, INFINITY), pow(0.5, INFINITY),
                           S21_PRECISION);
}
END_TEST

START_TEST(s21_pow_57) {
  ck_assert_ldouble_infinite(s21_pow(0.5, -INFINITY));
  ck_assert_ldouble_infinite(pow(0.5, -INFINITY));
}
END_TEST

START_TEST(s21_pow_58) {
  ck_assert_ldouble_infinite(s21_pow(1.5, INFINITY));
  ck_assert_ldouble_infinite(pow(1.5, INFINITY));
}
END_TEST

START_TEST(s21_pow_59) {
  ck_assert_ldouble_eq_tol(s21_pow(1.5, -INFINITY), pow(1.5, -INFINITY),
                           S21_PRECISION);
}
END_TEST
...
START_TEST(s21_pow_61) {
  ck_assert_ldouble_eq_tol(s21_pow(2.2, -2), pow(2.2, -2), S21_PRECISION);
}
END_TEST

START_TEST(s21_pow_62) {
  ck_assert_ldouble_eq_tol(s21_pow(2.2, -2.2), pow(2.2, -2.2), S21_PRECISION);
}
END_TEST

START_TEST(s21_pow_63) {
  ck_assert_ldouble_eq_tol(s21_pow(93.5, -83.5), pow(93.5, -83.5),
                           S21_PRECISION);
}
END_TEST
...
START_TEST(s21_sin_1) {
  long double test_val = 1;
  ck_assert_ldouble_eq_tol(s21_sin(test_val), sin(test_val), S21_PRECISION);
}
END_TEST
...
START_TEST(s21_sin_21) {
  for (int i = 0; i < 5; ++i) {
    ...
    ck_assert_ldouble_eq_tol(s21_sin(test_val), sin(test_val), S21_PRECISION);
    long double test_val_m = -i * S21_PI;
    ck_assert_ldouble_eq_tol(s21_sin(test_val_m), sin(test_val_m),
                             S21_PRECISION);
  }
}
END_TEST
...
START_TEST(s21_sin_22) {
  for (double i = -S21_PI; i <= S21_PI; i += 1.234567) {
    ck_assert_ldouble_eq_tol(sin(1234567890.123456 + i),
                             s21_sin(1234567890.123456 + i), S21_PRECISION);
  }
}
END_TEST
...
START_TEST(s21_sqrt_1) {
  ck_assert_ldouble_eq_tol(s21_sqrt(4), sqrt(4), S21_PRECISION);
}
END_TEST

START_TEST(s21_sqrt_2) {
  ck_assert_ldouble_eq_tol(s21_sqrt(9), sqrt(9), S21_PRECISION);
}
END_TEST

START_TEST(s21_sqrt_3) {
  ck_assert_ldouble_eq_tol(s21_sqrt(44.44), sqrt(44.44), S21_PRECISION);
}
END_TEST

START_TEST(s21_sqrt_4) {
  ck_assert_ldouble_eq_tol(s21_sqrt(44.444444), sqrt(44.444444), S21_PRECISION);
}
END_TEST
...
START_TEST(s21_sqrt_8) {
  ck_assert_ldouble_eq_tol(s21_sqrt(0.999999999), sqrt(0.999999999),
                           S21_PRECISION);
}
END_TEST

START_TEST(s21_sqrt_9) {
  ck_assert_ldouble_eq_tol(s21_sqrt(0.123123123), sqrt(0.123123123),
                           S21_PRECISION);
}
END_TEST
...
START_TEST(s21_sqrt_13) {
  ck_assert_ldouble_eq_tol(s21_sqrt(159159159159.159159159),
                           sqrt(159159159159.159159159), S21_PRECISION);
}
END_TEST
...
START_TEST(s21_sqrt_15) {
  ck_assert_ldouble_eq_tol(s21_sqrt(17.01), sqrt(17.01), S21_PRECISION);
}
END_TEST

START_TEST(s21_tan_1) {
  long double test_val = 1;
  ck_assert_ldouble_eq_tol(s21_tan(test_val), tan(test_val), S21_PRECISION);
}
END_TEST
...
START_TEST(s21_tan_21) {
  for (int i = 0; i < 5; ++i) {
    ...
    ck_assert_ldouble_eq_tol(s21_tan(test_val), tan(test_val), S21_PRECISION);
    long double test_val_m = -i * S21_PI;
    ck_assert_ldouble_eq_tol(s21_tan(test_val_m), tan(test_val_m),
                             S21_PRECISION);
  }
}
END_TEST
